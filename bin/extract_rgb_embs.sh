#!/bin/bash
#SBATCH --job-name=vjepa_ext_rgb
#SBATCH --output=/home/lucas.ueda/slurm/vjepa_rgb_%j.out
#SBATCH --error=/home/lucas.ueda/slurm/vjepa_rgb_%j.err
#SBATCH --ntasks=1
...
python ~/github/AIMS_3rd_EgoVis/src/preprocessing/extract_embeddings.py \
    --input_dir /hadatasets/EPIC-KITCHENS_rgb_crops \
